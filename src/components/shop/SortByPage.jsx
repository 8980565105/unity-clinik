  ...
  return (
    ...
    >
      ...
      >
        ...
        <div className="w-full bg-white rounded-t-[15px]  py-[20px] overflow-hidden">
          <div className="px-[20px]">
            <div className="flex justify-start items-center items-end pb-[15px] border-b border-gray-300">
              <h2 className="text-[20px] font-roboto font-medium text-gray-900">
                Sort By
              </h2>
            </div>
          </div>
              ...
              return (
                ...
                >
                  <div className="flex items-center gap-[12px]">
                    ...
                    <span
                      className={`text-[14px] font-sans font-[400] leading-[19px] ${textColor}`}
                    >
                      {option.label}
                    </span>
                  </div>
