...
// // import {createCustomerReview, updateReviewsStatus ,getCustomerReviewById} from "@/features/customerReviews/customerReviewsThunk"
...
// //                             {isEditMode ? "Update reviews" : "Create reviews"}
// //                         </Button>
...
//     const handleSubmit = async (e: React.FormEvent) => {
//         e.preventDefault();
//         const payload = { product_id: productId, rating, title, comment };
...
//                         <CardContent className="space-y-5">
//                             <div>
//                                 <Label htmlFor="productId">Product ID <span className="text-red-500">*</span></Label>
//                                 <Input
//                                     id="productId"
...
export default function CustomerReviewsForm() {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        e.preventDefault();
        // const payload = { product_id: productId, rating, title, comment, status: status ? "active" : "inactive", };
